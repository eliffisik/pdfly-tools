...
export const dictionaries = {
  en: {
    ...
    common: {
      ...
      invalidImageFile: "Only JPG and PNG images are supported.",
      invalidTxtFile: "Only TXT files are supported.",
      selectPdfFile: "Please choose a PDF file first.",
      selectAtLeastTwoPdfs: "Please choose at least two PDF files.",
      selectImageFile: "Please choose at least one image.",
      enterPageRanges: "Please enter page ranges first.",
      enterPageOrder: "Please enter the new page order first.",
      enterStartNumber: "Please enter a start number.",
      enterTextOrTxt: "Please type text or upload a TXT file first.",
  ...
  tr: {
    ...
    common: {
      ...
      invalidPdfFile: "Sadece PDF dosyaları desteklenir.",
      invalidImageFile: "Sadece JPG ve PNG görseller desteklenir.",
      invalidTxtFile: "Sadece TXT dosyaları desteklenir.",
      selectPdfFile: "Önce bir PDF dosyası seçmelisin.",
      selectAtLeastTwoPdfs: "En az iki PDF dosyası seçmelisin.",
      selectImageFile: "En az bir görsel seçmelisin.",
      enterPageRanges: "Önce sayfa aralıklarını girmelisin.",
      enterPageOrder: "Önce yeni sayfa sırasını girmelisin.",
      enterStartNumber: "Başlangıç numarası girmelisin.",
      enterTextOrTxt: "Önce metin yazmalı veya bir TXT dosyası yüklemelisin.",
